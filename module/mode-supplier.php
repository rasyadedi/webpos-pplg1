...
function insert($data)
{
  ...
  // variable 
  $sqlSupplier = "INSERT INTO tbl_supplier VALUES (null, '$nama', '$telpon', '$alamat')";
...
function update($data)
{
  ...
  $sqlSupplier = "UPDATE tbl_supplier SET nama = '$nama', telp = '$telpon', alamat = '$alamat' WHERE id_supplier = '$id' ";
  mysqli_query($koneksi, $sqlSupplier);
  return mysqli_affected_rows($koneksi);
}
